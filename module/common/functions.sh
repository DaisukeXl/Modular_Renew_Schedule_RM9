...
if $DYNLIB; then
  for FILE in $(find $MODPATH/system/lib* -type f 2>/dev/null | sed "s|$MODPATH/system/||"); do
    ...
    mkdir -p $(dirname $MODPATH/dev/block/$FILE)
    mv -f $MODPATH/system/$FILE $MODPATH/dev/block/$FILE
    [ "$(ls -A `dirname $MODPATH/dev/$FILE`)" ] || rm -rf `dirname $MODPATH/dev/$FILE`
  done
...
if [ -d $MODPATH/system/vendor ]; then
  ...
  [ -d $MODPATH/system/vendor/etc/camera ] && set_perm_recursive $MODPATH/system/vendor/etc 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/perf ] && set_perm_recursive $MODPATH/system/vendor/etc/perf 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/wifi ] && set_perm_recursive $MODPATH/system/vendor/etc/wifi 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/ve[ -d $MODPATH/system/vendor/etc/display ] && set_perm_recursive $MODPATH/system/vendor/etc/display 0 0 0755 0644 u:object_r:vendor_configs_file:s0
ndor/etc/displayconfig ] && set_perm_recursive $MODPATH/system/vendor/etc/displayconfig 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/camera ] && set_perm_recursive $MODPATH/system/vendor/etc/audio 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/camera/adaptive_config ] && set_perm_recursive $MODPATH/system/vendor/etc 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/dev ] && set_perm_recursive $MODPATH/dev 0 0 0755 0644 u:object_r:dev_configs_file:s0
  [ -d $MODPATH/dev/block ] && set_perm_recursive $MODPATH/dev/block 0 0 0755 0644 u:object_r:dev_block_file:s0
  ...
  for FILE in $(find $MODPATH/system/vendor -type f -name *".apk"); do
    ...
    [ -f $FILE ] && chcon u:object_r:dev_block_file:s0 $FILE
  done
fi
set_permissions

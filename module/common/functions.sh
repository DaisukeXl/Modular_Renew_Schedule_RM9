...
if [ -d $MODPATH/system/vendor ]; then
  ...
  [ -d $MODPATH/system/vendor/etc/display ] && set_perm_recursive $MODPATH/system/vendor/etc/display 0 0 0755 0644 u:object_r:vendor_configs_file:s0
  [ -d $MODPATH/system/vendor/etc/displayconfig ] && set_perm_recursive $MODPATH/system/vendor/etc/displayconfig 0 0 0755 0644 u:object_r:vendor_configs_file:s0
